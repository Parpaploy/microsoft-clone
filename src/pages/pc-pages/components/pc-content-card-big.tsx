...
import "./pc-content-card-big.css";

export default function PcContentCardBig(props: IPcContentCardProps) {
  return (
    <>
      <div className="w-[30%] h-auto flex flex-1 flex-col bg-white pc-card">
        ...
        >
          <div className="min-h-[5.5vw] font-medium text-[1.9vw] pc-card-title">
            {props.title}
          </div>
          <div className="text-[1.1vw] min-h-[11svh] pc-card-title">
            {props.description}
          </div>
        </div>
        ...
        >
          <button
            ...
            className="w-fit text-white text-[1.1vw] font-medium bg-[#0167B8] pc-card-btn"
          >
            {props.buttonName}
          </button>
        </div>
